...
pizza_order_msgs__srv__CancelService_Request__create()
{
  ...
  pizza_order_msgs__srv__CancelService_Request * msg = (pizza_order_msgs__srv__CancelService_Request *)allocator.allocate(sizeof(pizza_order_msgs__srv__CancelService_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pizza_order_msgs__srv__CancelService_Request));
  bool success = pizza_order_msgs__srv__CancelService_Request__init(msg);
  if (!success) {
...
pizza_order_msgs__srv__CancelService_Request__destroy(pizza_order_msgs__srv__CancelService_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    pizza_order_msgs__srv__CancelService_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
pizza_order_msgs__srv__CancelService_Request__Sequence__init(pizza_order_msgs__srv__CancelService_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pizza_order_msgs__srv__CancelService_Request * data = NULL;

  if (size) {
    data = (pizza_order_msgs__srv__CancelService_Request *)allocator.zero_allocate(size, sizeof(pizza_order_msgs__srv__CancelService_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pizza_order_msgs__srv__CancelService_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pizza_order_msgs__srv__CancelService_Request__fini(&data[i - 1]);
      }
...
pizza_order_msgs__srv__CancelService_Request__Sequence__fini(pizza_order_msgs__srv__CancelService_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pizza_order_msgs__srv__CancelService_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pizza_order_msgs__srv__CancelService_Request__Sequence * array = (pizza_order_msgs__srv__CancelService_Request__Sequence *)allocator.allocate(sizeof(pizza_order_msgs__srv__CancelService_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pizza_order_msgs__srv__CancelService_Request__Sequence__init(array, size);
  if (!success) {
...
pizza_order_msgs__srv__CancelService_Request__Sequence__destroy(pizza_order_msgs__srv__CancelService_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pizza_order_msgs__srv__CancelService_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pizza_order_msgs__srv__CancelService_Request__Sequence__are_equal(const pizza_order_msgs__srv__CancelService_Request__Sequence * lhs, const pizza_order_msgs__srv__CancelService_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pizza_order_msgs__srv__CancelService_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pizza_order_msgs__srv__CancelService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pizza_order_msgs__srv__CancelService_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pizza_order_msgs__srv__CancelService_Request * data =
      (pizza_order_msgs__srv__CancelService_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pizza_order_msgs__srv__CancelService_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pizza_order_msgs__srv__CancelService_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pizza_order_msgs__srv__CancelService_Request__copy(
...
pizza_order_msgs__srv__CancelService_Response__are_equal(const pizza_order_msgs__srv__CancelService_Response * lhs, const pizza_order_msgs__srv__CancelService_Response * rhs)
{
  ...
  // cancel_result
  if (lhs->cancel_result != rhs->cancel_result) {
    return false;
  }
  return true;
}
  ...
  pizza_order_msgs__srv__CancelService_Response * output)
{
  ...
  // cancel_result
  output->cancel_result = input->cancel_result;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pizza_order_msgs__srv__CancelService_Response * msg = (pizza_order_msgs__srv__CancelService_Response *)allocator.allocate(sizeof(pizza_order_msgs__srv__CancelService_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pizza_order_msgs__srv__CancelService_Response));
  bool success = pizza_order_msgs__srv__CancelService_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pizza_order_msgs__srv__CancelService_Response__destroy(pizza_order_msgs__srv__CancelService_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    pizza_order_msgs__srv__CancelService_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
pizza_order_msgs__srv__CancelService_Response__Sequence__init(pizza_order_msgs__srv__CancelService_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pizza_order_msgs__srv__CancelService_Response * data = NULL;

  if (size) {
    data = (pizza_order_msgs__srv__CancelService_Response *)allocator.zero_allocate(size, sizeof(pizza_order_msgs__srv__CancelService_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pizza_order_msgs__srv__CancelService_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pizza_order_msgs__srv__CancelService_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pizza_order_msgs__srv__CancelService_Response__Sequence__fini(pizza_order_msgs__srv__CancelService_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pizza_order_msgs__srv__CancelService_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pizza_order_msgs__srv__CancelService_Response__Sequence * array = (pizza_order_msgs__srv__CancelService_Response__Sequence *)allocator.allocate(sizeof(pizza_order_msgs__srv__CancelService_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pizza_order_msgs__srv__CancelService_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pizza_order_msgs__srv__CancelService_Response__Sequence__destroy(pizza_order_msgs__srv__CancelService_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pizza_order_msgs__srv__CancelService_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pizza_order_msgs__srv__CancelService_Response__Sequence__are_equal(const pizza_order_msgs__srv__CancelService_Response__Sequence * lhs, const pizza_order_msgs__srv__CancelService_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pizza_order_msgs__srv__CancelService_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pizza_order_msgs__srv__CancelService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pizza_order_msgs__srv__CancelService_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pizza_order_msgs__srv__CancelService_Response * data =
      (pizza_order_msgs__srv__CancelService_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pizza_order_msgs__srv__CancelService_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pizza_order_msgs__srv__CancelService_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pizza_order_msgs__srv__CancelService_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
