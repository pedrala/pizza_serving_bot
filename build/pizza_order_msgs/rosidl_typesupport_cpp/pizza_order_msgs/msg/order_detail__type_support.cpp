...
static const _OrderDetail_type_support_symbol_names_t _OrderDetail_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pizza_order_msgs, msg, OrderDetail)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pizza_order_msgs, msg, OrderDetail)),
  }
};
...
{
  return &::pizza_order_msgs::msg::rosidl_typesupport_cpp::OrderDetail_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pizza_order_msgs, msg, OrderDetail)() {
  return get_message_type_support_handle<pizza_order_msgs::msg::OrderDetail>();
}
