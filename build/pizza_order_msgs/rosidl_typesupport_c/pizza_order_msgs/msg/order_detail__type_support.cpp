...
static const _OrderDetail_type_support_symbol_names_t _OrderDetail_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pizza_order_msgs, msg, OrderDetail)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pizza_order_msgs, msg, OrderDetail)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pizza_order_msgs, msg, OrderDetail)() {
  return &::pizza_order_msgs::msg::rosidl_typesupport_c::OrderDetail_message_type_support_handle;
}
