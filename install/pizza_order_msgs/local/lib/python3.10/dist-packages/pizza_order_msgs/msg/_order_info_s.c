...
bool pizza_order_msgs__msg__order_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pizza_order_msgs.msg._order_info.OrderInfo", full_classname_dest, 42) == 0);
  }
  pizza_order_msgs__msg__OrderInfo * ros_message = _ros_message;
  {  // order_id
...
PyObject * pizza_order_msgs__msg__order_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pizza_order_msgs.msg._order_info");
